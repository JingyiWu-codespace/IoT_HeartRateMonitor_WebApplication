...
#define CY_BLE_SCN_PKT_0_INDEX_APPEARANCE   (0x00u)
 ...
 */
#define CY_BLE_SPO2_MEASUREMENT_SERVICE_INDEX   (0x00u) /* Index of SpO2 Measurement service in the cy_ble_customs array */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_SPO2_MEASUREMENT_SERVICE_HANDLE   (0x0030u) /* Handle of SpO2 Measurement service */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0031u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0032u) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0033u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_SPO2_MEASUREMENT_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0034u) /* Handle of Client Characteristic Configuration descriptor */
