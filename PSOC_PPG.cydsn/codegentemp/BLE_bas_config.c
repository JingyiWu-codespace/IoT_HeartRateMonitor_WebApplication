...
static const cy_stc_ble_bass_t cy_ble_bass[0x01u] = {
    {
        0x002Bu, /* Handle of the BAS service */ 
        0x002Du, /* Handle of the Battery Level characteristic */ 
        0x002Eu, /* Handle of the Characteristic Presentation Format descriptor */ 
